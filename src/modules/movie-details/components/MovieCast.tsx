    ...
    return (
        <section className="py-12 bg-gray-900">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-white mb-8">Elenco Principal</h2>
                        ...
                        <div key={member.id} className="text-center">
                            <div className="relative mb-4">
                                {member.profile_path ? (
                                    ...
                                    <div className="w-full aspect-[3/4] bg-gray-700 rounded-lg shadow-lg flex items-center justify-center">
